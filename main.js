...
const shoppindCartContainer = document.querySelector("#shoppingCartContainer");
...
function toggleDesktopMenu() {
  const isAsideClosed = shoppindCartContainer.classList.contains("inactive");

  if (!isAsideClosed) {
    shoppindCartContainer.classList.add("inactive");
  }
...
function toggleMenuProductDetail() {
  ...
  shoppindCartContainer.classList.toggle("inactive");
}
